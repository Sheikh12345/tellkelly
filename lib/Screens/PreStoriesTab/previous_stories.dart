...
class PreviousStories extends StatefulWidget {
  @override
  _PreviousStoriesState createState() => _PreviousStoriesState();
}

class _PreviousStoriesState extends State<PreviousStories> with TickerProviderStateMixin{
                      ...
                      child: ListView.builder(
                        /// NeverScrollableScrollPhysics() this function helpful to make listView not scrollable
                          ...
                          itemBuilder: (_,index){
                            ...
                            child:Text("${doc["Title"]}",style: GoogleFonts.courgette(color: Colors.black,height: 2,fontSize: size.width*0.06,fontWeight: FontWeight.w600)),
                            margin: EdgeInsets.only(bottom: size.height*0.12,left: size.width*0.03,right:  size.width*0.03),
                            ) : Container(
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        children: [
                                          Text("${doc["Title"]}",style: TextStyle(color: primaryColor,height: 2),),Container(
                                            width:size.width,
                                            child: GestureDetector(
                                              child: Row(
                                                ...
                                                )),Icon(Icons.arrow_forward_ios,color: secondaryColor,size: size.width*0.025,)
                                              ],),
                                              onTap: (){
                                                moveToReadStory(
                                                  title: doc
